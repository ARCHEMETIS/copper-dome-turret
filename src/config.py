...
# ---------- Tilt (มุมเงย — คุมระยะยิงแทน PWM 100%) ----------
# หน้าไม้แรงดึงคงที่ (เฟืองครึ่งวงดึงระยะเท่าเดิมทุกนัด) จึงคุมระยะด้วยมุมเงยแทนความแรงมอเตอร์
# TODO: ทั้ง 3 ค่านี้ต้องวัดจากของจริงหลังประกอบเฟือง rack เสร็จ (กันเฟืองชนกัน/servo หลุด)
...
TILT_SETTLE_S = 0.3         # รอ servo นิ่งก่อนดึง/ยิง
...
# ตาราง calibration: (ระยะ_mm, มุมเงย_deg) — ได้จาก tools/calibrate_angle.py
...
# สนามจริง 1.5-2.4m → ค่านี้ป้อนเข้า ranging.angle_for_distance เหมือน ranging ปกติ
