...
class Turret:
    def __init__(self, port: str | None = None):
        ...
        if self._is_crossbow:
            ...
            # ล้อขวา (B/OUT3,4) กลับทิศผ่าน IN ได้ปกติ = (in3,1)(in4,0)
            # ล้อซ้าย (A/OUT1,2) ยืนยันแล้ว 24 ก.ค.: ช่อง L298N ฝั่งนี้พังครึ่งเดียว ขับได้ทิศเดียว —
            #   สั่ง (in1,0)(in2,1) แล้วมอเตอร์ไม่ติด จึงคง IN ที่ทิศใช้ได้ =(in1,1)(in2,0)
            #   แล้วกลับทิศจริงด้วยการสลับสายมอเตอร์ 2 เส้นที่ขั้ว OUT1/OUT2 แทน
            dir_values = ((in1, 1), (in2, 0), (in3, 1), (in4, 0))
