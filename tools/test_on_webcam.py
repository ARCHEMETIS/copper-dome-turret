...
# คลิกซ้าย = ล็อกเป้า | คลิกขวา = ปลดล็อก | q / ESC = ปิดหน้าต่าง
# (โหมดนี้ไม่ต่อป้อม กด F จะไม่ยิง — ไว้ทดสอบ detection + HUD บนกล้องจริง
#  ถ้าต่อ Arduino ครบแล้วอยากยิงจริง ใช้:  python src\main_click.py)
# =============================================================
import sys
