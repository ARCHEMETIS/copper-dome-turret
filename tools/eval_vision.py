...
#
# วัด 3 ขา ต่อโมเดล:
#   A) mAP50 / mAP50-95 บน dataset/test (320 รูป = 280 มีเป้า + 40 background
#      จากคลิปห้องนอน 23 ก.ค.)
#      ⚠ เทียบกับเลขเก่าก่อน 10 ก.ค. ไม่ได้ — label ใน test ถูกแก้ไปแล้ว
#      ⚠ เทียบกับเลขก่อน 23 ก.ค. ก็ไม่ได้ — test เพิ่ม background 40 รูป
#        (background ดันค่า precision/mAP ของโมเดลที่เห็น negative ตอนเทรน
#        ให้ดูดีขึ้น) จะเทียบข้ามวันต้องวัดเฉพาะ 280 รูปเดิม
